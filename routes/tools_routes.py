...
def get_category_description(category):
    ...
    descriptions = {
        ...
        'other': 'Miscellaneous calculators and tools',
        # Handle your specific categories
        'health & insurance': 'Health and insurance calculators with AI-powered insights',
        'verzekeringen': 'Insurance calculators and coverage analysis tools for Netherlands',
        'Health & Insurance': 'Health and insurance calculators with AI-powered insights',
        'Verzekeringen': 'Insurance calculators and coverage analysis tools for Netherlands'
    }
    return descriptions.get(category.lower(),'Professional calculators and analysis tools')